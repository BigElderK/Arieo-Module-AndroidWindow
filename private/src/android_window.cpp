...
namespace Arieo
{
    ...
    Base::Interop::RawRef<Interface::Window::IWindow> AndroidWindowManager::createWindow(std::uint16_t pos_x, std::uint16_t pos_y, std::uint16_t width, std::uint16_t height)
    {
    ...
    Base::Interop::RawRef<Interface::Window::IWindow> AndroidWindowManager::getMainWindow()
    {
        if(m_android_main_window == nullptr)
        {
            ...
            m_android_main_window = Base::Interop::RawRef<Interface::Window::IWindow>::createAs<AndroidWindow>(m_android_app);
    ...
    void AndroidWindowManager::destroyWindow(Base::Interop::RawRef<Interface::Window::IWindow> window)
    {
        ...
        // Base::Interop::RawRef<Interface::Window::IWindow>::destroyAs<AndroidWindow>(std::move(window));
    }
